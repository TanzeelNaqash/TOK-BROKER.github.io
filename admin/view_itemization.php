...
if (isset($_POST['delete'])) {
    ...
    if ($verify_delete->rowCount() > 0) {
       ...
       $success_msg[] = 'Itemization deleted!';
    } else {
...
<head>
    ...
    <title> TOK-BROKER - Admin-Dashboard - Itemization Details</title>
...
<body onload="myfunction()">
   ...
   <section class="view-itemization">

   <h1 class="heading">Itemization details</h1>
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <form action="" method="post" class="flex-btn">
         <input type="hidden" name="delete_id" class=".delete_item_value" value="<?= $property_id; ?>">
         <input type="submit" value="delete property" name="delete" class="delete-btn" onclick="return confirm('delete this Property?');">
