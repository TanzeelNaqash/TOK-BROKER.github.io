...
<head>
   ...
   <title>Welcome to TOK-BROKER - get your best choice! - Bookmark</title>
</head>
   ...
   <section class="all_itemization">
      ...
      <div class="box-container">
         ...
         ?>
                     <form action="" method="POST">
                        <div class="box">
                           ...
                           ?>
                              <button type="submit" name="save" class="save"><i class="fas fa-bookmark"></i><span>remove from saved</span></button>
                           <?php
                           } else {
                           ?>
         ...
         <?php
            ...
            echo '<p class="empty">no properties saved yet! <a href="all_itemization.php" style="margin-top:1.5rem;" class="btn">discover more</a></p>';
         }
         ?>
