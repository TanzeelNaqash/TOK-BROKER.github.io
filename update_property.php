...
if(isset($_POST['update'])){
   ...
   $deposite = htmlspecialchars($deposite);
   ...
   $furnished = htmlspecialchars($furnished);
   $bhk = $_POST['bhk'];
   $bhk = htmlspecialchars($bhk);
   $bedroom = $_POST['bedroom'];
   $bedroom = htmlspecialchars($bedroom);
   $bathroom = $_POST['bathroom'];
   $bathroom = htmlspecialchars($bathroom);
   $balcony = $_POST['balcony'];
   $balcony = htmlspecialchars($balcony);
   $carpet = $_POST['carpet'];
   $carpet = htmlspecialchars($carpet); 
   $age = $_POST['age'];
   $age = htmlspecialchars($age);
   $total_floors = $_POST['total_floors'];
   $total_floors = htmlspecialchars($total_floors);
   ...
   if(isset($_POST['lift'])){
      $lift = $_POST['lift'];
      $lift = htmlspecialchars($lift);
   }else{
      $lift = 'no';
   }
   if(isset($_POST['security_guard'])){
      $security_guard = $_POST['security_guard'];
      $security_guard = htmlspecialchars($security_guard);
   }else{
      $security_guard = 'no';
   }
   if(isset($_POST['play_ground'])){
      $play_ground = $_POST['play_ground'];
      $play_ground = htmlspecialchars($play_ground);
   }else{
      $play_ground = 'no';
   }
   if(isset($_POST['garden'])){
      $garden = $_POST['garden'];
      $garden = htmlspecialchars($garden);
   }else{
      $garden = 'no';
   }
   if(isset($_POST['water_supply'])){
      $water_supply = $_POST['water_supply'];
      $water_supply = htmlspecialchars($water_supply);
   }else{
      $water_supply = 'no';
   }
   if(isset($_POST['power_backup'])){
      $power_backup = $_POST['power_backup'];
      $power_backup = htmlspecialchars($power_backup);
   }else{
      $power_backup = 'no';
   }
   if(isset($_POST['parking_area'])){
      $parking_area = $_POST['parking_area'];
      $parking_area = htmlspecialchars($parking_area);
   }else{
      $parking_area = 'no';
   }
   if(isset($_POST['gym'])){
      $gym = $_POST['gym'];
      $gym = htmlspecialchars($gym);
   }else{
      $gym = 'no';
   }
   if(isset($_POST['shopping_mall'])){
      $shopping_mall = $_POST['shopping_mall'];
      $shopping_mall = htmlspecialchars($shopping_mall);
   }else{
      $shopping_mall = 'no';
   }
   ...
   if(isset($_POST['market_area'])){
      ...
      $market_area = htmlspecialchars($market_area);
   }else{
      $market_area = 'no';
   }

   $old_image_01 = $_POST['old_image_01'];
   $old_image_01 = htmlspecialchars($old_image_01);
   ...
   $old_image_02 = htmlspecialchars($old_image_02);
   ...
   $old_image_03 = htmlspecialchars($old_image_03);
   ...
   $old_image_04 = htmlspecialchars($old_image_04);
   $image_04 = $_FILES['image_04']['name'];
   $image_04 = htmlspecialchars($image_04);
   ...
   $old_image_05 = htmlspecialchars($old_image_05);
   $image_05 = $_FILES['image_05']['name'];
   $image_05 = htmlspecialchars($image_05);
   ...
   $success_msg[] = 'Itemization updated successfully!';
...
<title>Welcome to TOK-BROKER - get your best choice! - Update your property</title>
</head>
