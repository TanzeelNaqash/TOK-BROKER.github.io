...
if(isset($_POST['post'])){
   ...
   $deposit = htmlspecialchars($deposite);
...
<title>Welcome to TOK-BROKER - get your best choice! - Post your property</title>
</head>
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="box">
            ...
            <input type="number" name="carpet" required min="1" max="9999999999" maxlength="10" placeholder="how many squarefeet?" class="input">
         </div>
         <div class="box">
